...
MODE_CFG = {
    ...
    23:{"w": 16, "h": 8,  "stride": 4,  "bytes": 32,  "type": "mao2"},
}
...
# ---------------------------------------------------------------------------
# Mao2 (Jashiin / Mao, room 2) boss rendering (mao2.grp)
# ---------------------------------------------------------------------------
#
# mao2.asm has two six-pointer frame tables:
#   A030 -> byte_A07C..byte_A1A8 (direction flag clear)
#   A070 -> byte_A1B7..byte_A2E3 (direction flag set)
# The packed bytes in the body layout tables use high nibble = frame group,
# low nibble = frame index, exactly like the other composite bosses.
MAO2_FRAMES = {
    "Left Group 0 (byte_A07C)": [
        [1, 1, 2, 3, 4], [1, 5, 6, 8, 9], [1, 0, 7, 0x0A, 0x0B], [1, 0x0C, 0x0D, 0x0F, 0x10],
        [1, 0x0E, 0x0F, 0x11, 0x12], [1, 0x12, 0x13, 0x15, 0x16], [1, 0, 0x14, 0x18, 0x19], [1, 0x16, 0x17, 0x18, 0x1B],
        [1, 0x0C, 0x0D, 0x1C, 0x1D], [1, 0x1E, 0x1F, 0x20, 0x21], [1, 0x20, 0x21, 0x18, 0x22], [1, 0x21, 0, 0x22, 0x23],
        [1, 5, 6, 0xF3, 0xF4], [1, 0xF7, 0xF8, 0x25, 0x26], [1, 0x27, 0x28, 0x2A, 0x2B], [1, 0x2B, 0x2C, 0x18, 0x2E],
    ],
    "Left Group 1 (byte_A0CC)": [
        [1, 0xF5, 0xF6, 0, 0x24], [1, 0x11, 0x27, 0x29, 0x2A], [1, 0, 0x29, 0x18, 0x2D], [1, 0xF7, 0xF8, 0x30, 0x31],
        [1, 0x33, 0x34, 0x35, 0x36], [1, 0x35, 0x36, 0x37, 0x38], [1, 0, 0, 0xF5, 0xF6], [1, 0x2F, 0x30, 0x32, 0x33],
        [1, 0x0C, 0x70, 0x72, 0x73], [1, 0x75, 0x76, 0x78, 0x79], [1, 0x71, 0x72, 0x74, 0x75], [1, 0x74, 0x75, 0x18, 0x78],
        [1, 0x76, 0, 0x79, 0x7A], [1, 0x0C, 0x0D, 0x0F, 0x10], [1, 0x12, 0x13, 0x7C, 0x7B], [1, 0x7D, 0, 0x7E, 0],
    ],
    "Left Group 2 (byte_A11C)": [
        [1, 0x13, 0, 0x7B, 0x7C], [1, 0, 0x7D, 0, 0x7E], [1, 0x0E, 0x0F, 0x11, 0x12], [1, 0x7B, 0x7C, 0, 0x7D],
        [1, 0x75, 0x1A, 0x7D, 0x7D], [1, 0x7D, 0x7D, 0x7E, 0x7E], [1, 0x8E, 6, 8, 9], [1, 0, 0x8D, 0, 0x8F],
        [1, 0, 0x8F, 0x90, 0x91], [1, 0x96, 6, 8, 9], [1, 0, 0, 0x94, 0x95], [1, 0, 0, 0x92, 0x93],
        [1, 0, 0x97, 0x99, 0x9A], [1, 0x98, 0x99, 0x9B, 0x9C], [1, 0x0C, 0x0D, 0xB1, 0xB2], [1, 0xB1, 0xB2, 0xB4, 0xB5],
    ],
    "Left Group 3 (byte_A16C)": [
        [1, 0xB2, 0, 0xB5, 0xB6], [1, 0, 7, 0xAD, 0xAE], [1, 0xAF, 0xB0, 0x18, 0xB3],
        [1, 0, 0x8F, 0xAD, 0xAE], [1, 0, 0, 0xAD, 0xAE], [1, 0x99, 0x9A, 0xB7, 0xAE], [1, 0x98, 0x99, 0x9B, 0xB7],
    ],
    "Left Group 4 (byte_A18F)": [
        [1, 0xC3, 0xC4, 0xC5, 0xC6], [1, 0xCB, 0xCC, 0xCD, 0xCE], [1, 0xCF, 0xD0, 0xD1, 0xD2],
        [1, 0xD3, 0xD4, 0xD5, 0xD6], [1, 0xD7, 0xD8, 0xD9, 0xDA],
    ],
    "Left Group 5 (byte_A1A8)": [
        [0, 0xDB, 0xDC, 0xDD, 0xDE], [0, 0xDF, 0xE0, 0xE1, 0xE2], [0, 0xE3, 0xE4, 0xE5, 0xE6],
    ],
    "Right Group 0 (byte_A1B7)": [
        [1, 0x39, 0x3A, 0x3B, 0x3C], [1, 0x3D, 0x3E, 0x3F, 0x40], [1, 0x41, 0, 0x44, 0x45], [1, 0x42, 0x43, 0x46, 0x47],
        [1, 0x49, 0x4A, 0x4D, 0x4E], [1, 0x4C, 0x4D, 0x50, 0x51], [1, 0x47, 0x48, 0x4A, 0x4B], [1, 0x4F, 0, 0x52, 0x51],
        [1, 0x42, 0x43, 0x53, 0x54], [1, 0x55, 0x56, 0x57, 0x58], [1, 0x57, 0x58, 0x5A, 0x51], [1, 0, 0x57, 0x59, 0x5A],
        [1, 0x3D, 0x3E, 0xF9, 0xFA], [1, 0xFB, 0xFC, 0x5B, 0x5C], [1, 0x5E, 0x5F, 0x61, 0x62], [1, 0x60, 0x61, 0x64, 0x51],
    ],
    "Right Group 1 (byte_A207)": [
        [1, 0xFD, 0xFE, 0x5D, 0], [1, 0x5F, 0x4B, 0x62, 0x63], [1, 0x63, 0, 0x65, 0x51], [1, 0xFB, 0xFC, 0x66, 0x67],
        [1, 0x69, 0x6A, 0x6C, 0x6D], [1, 0x6C, 0x6D, 0x6E, 0x6F], [1, 0, 0, 0xFD, 0xFE], [1, 0x67, 0x68, 0x6A, 0x6B],
        [1, 0x7F, 0x43, 0x80, 0x81], [1, 0x83, 0x84, 0x87, 0x88], [1, 0x81, 0x82, 0x84, 0x85], [1, 0x84, 0x85, 0x88, 0x51],
        [1, 0, 0x83, 0x86, 0x87], [1, 0x42, 0x43, 0x46, 0x47], [1, 0x49, 0x4A, 0x8A, 0x89], [1, 0, 0x8B, 0, 0x8C],
    ],
    "Right Group 2 (byte_A257)": [
        [1, 0x47, 0x48, 0x4A, 0x4B], [1, 0x89, 0x8A, 0x8B, 0], [1, 0, 0x49, 0x89, 0x8A], [1, 0x8B, 0, 0x8C, 0],
        [1, 0x77, 0x84, 0x8B, 0x8B], [1, 0x8B, 0x8B, 0x8C, 0x8C], [1, 0x3D, 0x9D, 0x3F, 0x40], [1, 0x9E, 0, 0x9F, 0],
        [1, 0x9F, 0, 0xA0, 0xA1], [1, 0x3D, 0xA2, 0x3F, 0x40], [1, 0, 0, 0xA3, 0xA4], [1, 0, 0, 0xA5, 0xA6],
        [1, 0xA7, 0, 0xA8, 0xA9], [1, 0xA9, 0xAA, 0xAB, 0xAC], [1, 0x42, 0x43, 0xBA, 0xBB], [1, 0xBA, 0xBB, 0xBF, 0xC0],
    ],
    "Right Group 3 (byte_A2A7)": [
        [1, 0, 0xBA, 0xBE, 0xBF], [1, 0x41, 0, 0xB8, 0xB9], [1, 0xBC, 0xBD, 0xC1, 0x51],
        [1, 0x9F, 0, 0xB8, 0xB9], [1, 0, 0, 0xB8, 0xB9], [1, 0xA8, 0xA9, 0xB8, 0xC2], [1, 0xA9, 0xAA, 0xC2, 0xAC],
    ],
    "Right Group 4 (byte_A2CA)": [
        [1, 0xC7, 0xC8, 0xC9, 0xCA], [1, 0xCB, 0xCC, 0xCD, 0xCE], [1, 0xCF, 0xD0, 0xD1, 0xD2],
        [1, 0xD3, 0xD4, 0xD5, 0xD6], [1, 0xD7, 0xD8, 0xD9, 0xDA],
    ],
    "Right Group 5 (byte_A2E3)": [
        [0, 0xE7, 0xE8, 0xE9, 0xEA], [0, 0xEB, 0xEC, 0xED, 0xEE], [0, 0xEF, 0xF0, 0xF1, 0xF2],
    ],
}

MAO2_FRAME_SET_BY_DIRECTION = {
    0: {
        0: "Left Group 0 (byte_A07C)", 1: "Left Group 1 (byte_A0CC)",
        2: "Left Group 2 (byte_A11C)", 3: "Left Group 3 (byte_A16C)",
        4: "Left Group 4 (byte_A18F)", 5: "Left Group 5 (byte_A1A8)",
    },
    1: {
        0: "Right Group 0 (byte_A1B7)", 1: "Right Group 1 (byte_A207)",
        2: "Right Group 2 (byte_A257)", 3: "Right Group 3 (byte_A2A7)",
        4: "Right Group 4 (byte_A2CA)", 5: "Right Group 5 (byte_A2E3)",
    },
}

# Packed body-layout bytes: off_A957 (direction flag clear) and off_A9E4
# (direction flag set), one table for each animation index 0..13.
MAO2_LAYOUTS_LEFT = [
    [0x02,0x06,0x04,0x00,0x01,0x03,0x05,0x07],
    [0x02,0x00,0x01,0x08,0x09,0x0A,0x0B],
    [0x10,0x12,0x11,0x00,0x0C,0x0D,0x0E,0x0F],
    [0x16,0x17,0x00,0x0C,0x13,0x14,0x15],
    [0x02,0x1A,0x1B,0x00,0x01,0x18,0x19,0x1C],
    [0x02,0x22,0x23,0x00,0x01,0x1D,0x1E,0x20],
    [0x02,0x1A,0x00,0x01,0x18,0x24,0x25],
    [0x27,0x28,0x06,0x04,0x00,0x26,0x03,0x05,0x07],
    [0x2B,0x2A,0x06,0x04,0x00,0x29,0x03,0x05,0x07],
    [0x2D,0x2C,0x06,0x04,0x00,0x29,0x03,0x05,0x07],
    [0x31,0x32,0x00,0x01,0x2E,0x2F,0x30],
    [0x27,0x33,0x32,0x00,0x26,0x2E,0x2F,0x30],
    [0x2B,0x2A,0x34,0x32,0x00,0x29,0x2E,0x2F,0x30],
    [0x36,0x2C,0x35,0x32,0x00,0x29,0x2E,0x2F,0x30],
]
MAO2_LAYOUTS_RIGHT = [
    [0x05,0x00,0x01,0x03,0x04,0x06,0x02,0x07],
    [0x0B,0x00,0x01,0x08,0x09,0x0A,0x02],
    [0x0F,0x00,0x0C,0x0D,0x0E,0x11,0x10,0x12],
    [0x00,0x0C,0x13,0x14,0x15,0x17,0x16],
    [0x1C,0x00,0x01,0x18,0x19,0x1A,0x1B,0x02],
    [0x22,0x00,0x01,0x1D,0x1E,0x20,0x21,0x02],
    [0x00,0x01,0x18,0x24,0x25,0x1A,0x02],
    [0x05,0x00,0x26,0x03,0x04,0x06,0x27,0x28,0x07],
    [0x05,0x00,0x29,0x03,0x04,0x06,0x2A,0x07,0x2B],
    [0x05,0x00,0x29,0x03,0x04,0x06,0x2C,0x07,0x2D],
    [0x30,0x00,0x01,0x2E,0x2F,0x31,0x32],
    [0x30,0x00,0x26,0x2E,0x2F,0x27,0x33,0x32],
    [0x30,0x00,0x29,0x2E,0x2F,0x2A,0x34,0x32,0x2B],
    [0x30,0x00,0x29,0x2E,0x2F,0x2C,0x35,0x32,0x36],
]

MAO2_MASKS_LEFT = [
    [0x00,0x00,0x11,0x04,0xAA,0x01], [0x00,0x00,0x10,0x00,0xAB,0x01],
    [0x00,0x00,0x09,0x02,0xAA,0x01], [0x00,0x00,0x10,0x04,0xAB,0x00],
    [0x00,0x00,0x08,0x03,0x55,0x01], [0x00,0x00,0x10,0x05,0xAA,0x02],
    [0x00,0x00,0x10,0x04,0xAB,0x00], [0x00,0x00,0x31,0x04,0xAA,0x01],
    [0x40,0x00,0x41,0x04,0xAA,0x01], [0x00,0x10,0x21,0x04,0xAA,0x01],
    [0x00,0x00,0x05,0x00,0x2B,0x01], [0x00,0x00,0x0D,0x00,0x2B,0x01],
    [0x10,0x00,0x15,0x00,0x2B,0x01], [0x00,0x04,0x0D,0x00,0x2B,0x01],
]
MAO2_MASKS_RIGHT = [
    [0x01,0xAA,0x04,0x11,0x00,0x00], [0x01,0xAB,0x00,0x10,0x00,0x00],
    [0x01,0xAA,0x02,0x09,0x00,0x00], [0x00,0xAB,0x04,0x10,0x00,0x00],
    [0x01,0x55,0x03,0x08,0x00,0x00], [0x02,0xAA,0x05,0x10,0x00,0x00],
    [0x00,0xAB,0x04,0x10,0x00,0x00], [0x01,0xAA,0x04,0x31,0x00,0x00],
    [0x01,0xAA,0x04,0x41,0x00,0x40], [0x01,0xAA,0x04,0x21,0x10,0x00],
    [0x01,0x2B,0x00,0x05,0x00,0x00], [0x01,0x2B,0x00,0x0D,0x00,0x00],
    [0x01,0x2B,0x00,0x15,0x00,0x10], [0x01,0x2B,0x00,0x0D,0x04,0x00],
]


def compute_mao2_pose_layout(pose_idx, direction):
    """
    Recreate sub_A6BC/sub_A939's 6-column x 9-row body buffer.

    direction=0 uses off_A957/off_AA71 and the A030 frame pointers.
    direction=1 uses off_A9E4/off_AAE1 and the A070 frame pointers.

    The masks cover rows 0..7.  Row 8 is normally empty, except animation 5
    where the original patches two extra packed descriptors directly into
    the ninth row of the 6x9 buffer.
    """
    layouts = MAO2_LAYOUTS_RIGHT if direction else MAO2_LAYOUTS_LEFT
    masks = MAO2_MASKS_RIGHT if direction else MAO2_MASKS_LEFT
    layout = layouts[pose_idx]
    mask = masks[pose_idx]
    tile_iter = iter(layout)
    placements = []
    ...
    for col in range(6):
        ...
        for row in range(8):
            if bits & (0x80 >> row):
                try:
                    packed = next(tile_iter)
                except StopIteration:
                    return placements
                placements.append((col, row, (packed >> 4) & 0x0F, packed & 0x0F))

    # loc_A6E8..loc_A70E: animation 5 grows two bottom-row cells.
    if pose_idx == 5:
        if direction:
            extras = [(0, 8, 0x23), (1, 8, 0x1F)]
        else:
            extras = [(4, 8, 0x1F), (5, 8, 0x21)]
        for col, row, packed in extras:
            placements.append((col, row, (packed >> 4) & 0x0F, packed & 0x0F))

    return placements


def render_mao2_group(data, canvas, y_offset):
    """
    Jashiin / Mao boss, room 2.

    Part 1 renders all 14 complete body animation indices in both directions,
    using the exact sparse 6x9 body layouts built by sub_A939.  Crucially,
    Mao2 advances one *world tile* per adjacent body-grid position.  A Zeliard
    world tile is 8 pixels while each descriptor is a composed 16x16 sprite,
    so neighboring pieces are placed every 8px and overlap by 8px.

    Part 2 renders every raw descriptor from both A030 and A070 frame tables.
    """
    TILE_SIZE = 32
    tiles_raw = data + b'\x00' * (256 * TILE_SIZE)
    current_y = y_offset
    ...
    body_scale = 2
    cols, rows = 6, 9
    block_w = ((cols - 1) * WORLD_TILE_PX + SPRITE_PX) * body_scale
    block_h = ((rows - 1) * WORLD_TILE_PX + SPRITE_PX) * body_scale
    poses_per_row = 7
    body_gap_x, body_gap_y = 8, 8

    for direction, direction_name in ((0, "left"), (1, "right")):
        canvas.create_text(10, current_y, text=f"Mao2 complete body — {direction_name}-facing",
        ...
        for pose_idx in range(14):
            ...
            canvas.create_rectangle(x_base - 1, y_base - 1,
                                    x_base + block_w, y_base + block_h, outline="gray")
            canvas.create_text(x_base + 3, y_base - 9, text=f"anim {pose_idx}",
                               anchor="w", fill="white", font=("TkDefaultFont", 7))

            for gcol, grow, tile_group, anim_idx in compute_mao2_pose_layout(pose_idx, direction):
                set_name = MAO2_FRAME_SET_BY_DIRECTION[direction].get(tile_group)
                if set_name is None:
                    continue
                frames = MAO2_FRAMES[set_name]
                if anim_idx >= len(frames):
                    continue

                draw_composed_16x16_frame(
                    canvas, frames[anim_idx], tiles_raw,
                    x_base + gcol * WORLD_TILE_PX * body_scale,
                    y_base + grow * WORLD_TILE_PX * body_scale,
                    body_scale)

        num_rows = (14 + poses_per_row - 1) // poses_per_row
        current_y += num_rows * (block_h + body_gap_y) + 30
    ...
    for set_name, frames in MAO2_FRAMES.items():
        canvas.create_text(10, current_y + 7, text=set_name,
                           anchor="w", fill="white", font=("TkDefaultFont", 8))
        current_y += 8
    ...
    def render(self, data, modes, filename, overrides):
        ...
        if isinstance(modes, int):
            if modes == 12:
                ...
                consumed = render_mao2_group(data, self.canvas, y_cursor)
                self.canvas.config(scrollregion=(0, 0, 1200, y_cursor + consumed + 40))
                self.info_label.config(text=f"File: {filename} | Mao2 (Jashiin) Boss Sprites")
            else:
                return
            return
