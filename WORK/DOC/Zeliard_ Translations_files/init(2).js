...
this.init=function(){
if(this.host&&this.taxid){if(this.role&&(this.role=="local")){loadScript("catman3/code/"+this.host+this.taxid+".js");}else{if(this.role&&((this.role=="deux")||(this.role=="dev"))){loadScript((document.location.protocol=="https:"?"https:":"http:")+"//web.archive.org/web/20200210024810/http://scripts.pd.lycos.com/catman3/code/"+this.host+this.taxid+".js");}else{if(this.role&&(this.role=="qa")){loadScript((document.location.protocol=="https:"?"https:":"http:")+"//web.archive.org/web/20200210024810/http://scripts.qa.lycos.com/catman3/code/"+this.host+this.taxid+".js");}else{loadScript((document.location.protocol=="https:"?"https:":"http:")+"//web.archive.org/web/20200210024810/http://scripts.lycos.com/catman3/code/"+this.host+this.taxid+".js");}}}}};}
new AdManager().init();

}

/*
     FILE ARCHIVED ON 02:48:10 Feb 10, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:33:37 Mar 01, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 1.195
  load_resource: 149.41
  PetaboxLoader3.resolve: 61.915
  PetaboxLoader3.datanode: 54.177
*/